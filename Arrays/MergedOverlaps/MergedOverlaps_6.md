...
4. **Graph-based Approach (Alternative)**
   ```java
   class Solution {
...
9. Intervals with same end time
10. One interval completely inside another
11. Adjacent intervals (end = start)
12. Negative intervals
